...
import { DeleteDropdownItem, EditDropdownItem, ViewDropdownItem } from '@/components/ui/dropdown-items';
  ...
  return (
    <Card className={clsx(!!game.active && 'outline-2 outline-emerald-500/50')}>
      ...
      <CardContent>
        ...
        <div className="flex flex-row justify-between fkex-nowrap h-8">

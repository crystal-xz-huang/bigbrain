...
/***************************************************************
                     Checkbox Primary
***************************************************************/
export function CheckboxPrimaryGroup({
  className,
  ...props
}: React.ComponentPropsWithoutRef<'div'>) {
  return (
...
export function CheckboxPrimaryField({
  children,
  className,
  ...props
}: { children?: React.ReactNode; className?: string } & Omit<Headless.FieldProps, 'as' | 'className'>) {
  return (
    <Headless.Field
      data-slot="field"
...
export function CheckboxButton({ className, checked, toggleChecked }) {
  const styles = {
    ...
    correct: 'bg-emerald-400 shadow-emerald-800',
  ...
  return (
    <Headless.Checkbox
      ...
      className={clsx(
        className,
        styles.base,
        checked ? styles.correct : styles.false
      )}

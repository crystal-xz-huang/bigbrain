...
import type { QuestionAnswer } from '@prisma/client';
...
export function SingleAnswerInput({ answers, handleChange, addNewAnswer }: AnswerInputProps) {
    ...
    <>
      ...
      <Field>
        ...
        >
          ...
          {falseAnswers.length < 3 && (<AddAnswerButton onClick={addNewAnswer}/>)}
        </InputGroup>
      </Field>
    </>
  );

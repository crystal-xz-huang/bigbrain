...
import DeleteGame from '@/components/ui/games/buttons/delete-game';
import DeleteQuestion from '@/components/ui/games/buttons/delete-question';
import {
  ControlGroup,
  ControlWrapper,
  Field,
  ...
  Legend,
  Textarea,
} from '@/components/ui/games/edit-form/input';
import {
  MultipleAnswerInput,
  QuestionField,
  QuestionFieldGroup,
  ...
  SingleAnswerInput,
  TypeAnswerInput,
} from '@/components/ui/games/edit-form/question-input';
...
export default function EditForm({
  ...
  const addNewAnswer = (questionId: string, correct: boolean) => {
    const newAnswerObj = newAnswer(questionId, correct);
    setQuestions((prev: QuestionWithAnswers[]) =>
      prev.map((q) =>
        q.id === questionId
            ...
            <FieldGroup className="flex flex-col w-full !space-y-4 gap-y-0">
              ...
              {question.type === QuestionType.MULTIPLE && (
                <MultipleAnswerInput
                  ...
                  addNewAnswer={() => addNewAnswer(question.id, false)}
                />
              )}
              {question.type === QuestionType.TYPE_ANSWER && (
                <TypeAnswerInput
                  ...
                  addNewAnswer={() => addNewAnswer(question.id, true)}
                />
              )}

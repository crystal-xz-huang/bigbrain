...
export function Label({ className, required, ...props }: { className?: string; required?: boolean} & Omit<Headless.LabelProps, 'as' | 'className'>) {
  return (
    <Headless.Label
      data-slot="label"
      {...props}
...
export function ErrorMessage({
  ...
  return (
    <Headless.Description
      data-slot="error"
      {...props}
      className={clsx(className, 'text-base/6 text-rose-600 data-disabled:opacity-50 sm:text-sm/6 dark:text-rose-500')}
    />
  )
}

...
export function CardContent({
  ...
  return (
    <div
      className={clsx(
        'rounded-b-xl flex flex-col w-full space-y-3 bg-transparent',
        className
      )}
      {...props}
    />
...
export function CardTitle({
  ...
  return 'href' in props ? (
    <Link
      {...props}
      className={clsx('leading-none line-clamp-2 font-semibold', className)}
    />
  ) : (
    <Text
      {...props}
...
export function CardAction({
  ...
  return (
    <div
      className={clsx(
        'flex flex-row items-center justify-between h-8',
        className
      )}
      {...props}
    />
